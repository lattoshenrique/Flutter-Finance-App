        ...
        child: Column(children: [
          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
            Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Text("Dia $day",
                  style:
                      AppStyles.head2.copyWith(fontSize: media.width * 0.05)),
              Text(date,
                  style: AppStyles.head2.copyWith(
                      color: Colors.grey,
            ...
            Container(
              padding: EdgeInsets.symmetric(
                  horizontal: media.width * 0.04, vertical: media.width * 0.02),
              decoration: BoxDecoration(
                color: type == 0
              ...
              child: Text(value,
                  style: AppStyles.body1.copyWith(
                      fontSize: media.width * 0.04, color: Colors.black)),
            )
          ]),
              ...
              child: Column(children: [
                Container(
                    ...
                    child: Row(
                        ...
                        children: [
                          Flexible(
                              child: Text("Variação em relação a D-1:",
                                  style: AppStyles.body1.copyWith(
